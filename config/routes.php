...
return static function (Application $app, MiddlewareFactory $factory, ContainerInterface $container): void {
    ...
    $app->route('/client/assign-project', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\AttachHandler::class], ['POST', 'OPTIONS', 'HEAD'], 'client.attach');
    $app->route('/client/dashboard', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\DashboardHandler::class], ['GET', 'OPTIONS', 'HEAD'], 'client.dashboard');
};
